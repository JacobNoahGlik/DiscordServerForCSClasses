...
👥 Assigning Roles:
First things first, head over to the ⁠roles chat and give Carlbot a little react to snag your academic year, major, or any other roles you fancy.
...
In our community, mutual respect is paramount. Treat each other with kindness, understanding, and empathy. We're all in this together, so let's make this space one where everyone feels welcome and valued.

🚀 Enjoy Your Stay:
So go ahead, dive into the discussions, ask those burning questions, and let's conquer algorithms together! 💪👩‍💻👨‍💻
```
