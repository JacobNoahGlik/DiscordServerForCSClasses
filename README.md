...
Level 1: &ensp;`@Entry Level Yapper 🏅 (Level 1)` (color code: `` #3787e9 `` <code style="color: #3787e9">#3787e9</code>) \
Level 5: &ensp;`@Yap City 🏙️ (Level 5)` (color code: `` `#10c9be` `` {:#10c9be}) \
Level 10: `@Yap Nobility 🏰 (Level 10)` (color code: `` `#0cc0a2` `` {:#0cc0a2}) \
Level 15: `@Social Royalty 👑 (Level 15)` (color code: `` `#05b112` `` {:#05b112})
